...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action=${pageContext.request.contextPath}/alipay method=post
			  target="_blank">
		...
		<form name=traderefundquery
			action=alipay.trade.fastpay.refund.query.jsp
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "${studentname}的学费";
		document.getElementById("WIDtotal_amount").value = ${totalprice};
		document.getElementById("WIDbody").value = "这就是你的学费，不交不教！！！"
	}
	GetDateNow();
</script>
</html>