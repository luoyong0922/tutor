...
<div id="content">
    <div id="query">
        <div id="query1">
            ...
            <%--</div>--%>
            <form action="${pageContext.request.contextPath}/getTeacherbypage" method="post">
                搜索关键词：
            ...
            <div style="margin: auto">
                <form action="${pageContext.request.contextPath}/getTeacherbypage" method="post" id="pageForm" >
