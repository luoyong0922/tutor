...
<div class="all">
    <div class="header">
        ...
        <ul>
            ...
            <li>
                <a href="${pageContext.request.contextPath}/teaRegister">老师加入</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/parentsRegister">用户加入</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/LOGIN/login">登录</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/registerChoose">注册</a>
            </li>
            <li class="slider"></li>
        </ul>
    </div>
