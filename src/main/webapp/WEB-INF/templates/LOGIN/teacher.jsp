...
<%
    ...
    if (session.getValue("password") == null)
        out.print("<script>alert('请教师先登录！');window.location.href='login'</script>");
%>
...
<div id="all">
    <div class="header">
        ...
        <ul>
                ...
                <a href="${pageContext.request.contextPath}/editPersonalInfo?teaname=${teaname}"><li>个人中心</li></a>
                <a href="${pageContext.request.contextPath}/getcoursesbypage?teaname=${teaname}"><li>课程安排</li></a>
                <a href="${pageContext.request.contextPath}/chatteainfo"><li>聊天</li></a>
            <%--<li>--%>
...
<div id="sub">
    <div class="sub" onclick="window.open('${pageContext.request.contextPath}/COURSES/teachercourses?course=数学');"><img src="../img/Math.png" class="img1" />
        <h3>数学</h3></div>
    <div class="sub" onclick="window.open('${pageContext.request.contextPath}/COURSES/teachercourses?course=语文');"><img src="../img/Chinese.png" class="img1" />
        <h3>语文</h3></div>
    <div class="sub" onclick="window.open('${pageContext.request.contextPath}/COURSES/teachercourses?course=英语');"><img src="../img/English.png" class="img1" />
        <h3>英语</h3></div>
    <div class="sub" onclick="window.open('${pageContext.request.contextPath}/COURSES/teachercourses?course=物理');"><img src="../img/Physics.png" class="img1" />
        <h3>物理</h3></div>
    <div class="sub" onclick="window.open('${pageContext.request.contextPath}/COURSES/teachercourses?course=化学');"><img src="../img/Chemical.png" class="img1" />
        <h3>化学</h3></div>
    <div class="sub" onclick="window.open('${pageContext.request.contextPath}/COURSES/teachercourses?course=生物');"><img src="../img/Biological.png" class="img1" />
        <h3>生物</h3></div>
</div>
...
<div id="teac">
    ...
    <table class="teac2">
        ...
        <tr>
            ...
            <td>
                <button class="md-trigger small" data-modal="modal-14" id="6"><img src="${pageContext.request.contextPath}/getUserImg2?teaname=安琪" style="height:150px;width: 200px; " /></div></button>
